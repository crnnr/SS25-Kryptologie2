...
\begin{enumerate}
  ...
  \item \textbf{Aufrufen der Web-Anwendung}: Die Studierenden öffnen die Web-App im Browser unter \texttt{https://localhost:8443} und erhalten eine Einführung in die Challenge.
